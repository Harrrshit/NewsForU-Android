...
public class Homecontainer extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.homecontainer, null);

        homerecyclerView = v.findViewById(R.id.homerecylerview);
    ...
    private void allNews() {
        ApiUtility.getApiInterface().getNews(country, 100, apiKey).enqueue(new Callback<NewsClass>() {
            @Override
